        ...
        switch (_a.label) {
            case 0:
                server = (0, fastify_1.default)({
                    logger: (0, common_1.createLogger)('saga-orchestrator'),
                });
                return [4 /*yield*/, server.register(cors_1.default)];
            case 1:
                _a.sent();
                server.addHook('onRequest', common_1.correlationMiddleware);
                server.get('/health', function () { return __awaiter(void 0, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        return [2 /*return*/, { status: 'ok', service: 'saga-orchestrator' }];
                    });
                }); });
